...
public class Lohnsteuer2010 implements LohnsteuerInterface {
	...
	protected BigDecimal KVSATZAG = new BigDecimal(0).setScale(5);

	/** Beitragssatz des Arbeitnehmers zur Krankenversicherung (5 Dezimalstellen) */
	protected BigDecimal KVSATZAN = new BigDecimal(0).setScale(5);
	...
	protected BigDecimal PVSATZAG = new BigDecimal(0).setScale(5);

	/** Beitragssatz des Arbeitnehmers zur Pflegeversicherung (5 Dezimalstellen) */
	protected BigDecimal PVSATZAN = new BigDecimal(0).setScale(5);
