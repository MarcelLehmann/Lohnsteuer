...
public class Lohnsteuer2014 implements LohnsteuerInterface {
	...
	/** Neuer Wert  2014 */
	protected static final BigDecimal RENTBEMESSUNGSGR_OST = new BigDecimal(60000);

	/** Rentenbemessungs-Grenze alte Bundesländer in EUR */

	/** Neuer Wert 2014 */
	protected static final BigDecimal RENTBEMESSUNGSGR_WEST = new BigDecimal(71400);
