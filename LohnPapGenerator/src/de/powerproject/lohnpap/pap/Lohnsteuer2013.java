...
public class Lohnsteuer2013 implements LohnsteuerInterface {

	/** Stand: 2013-02-22, 10:25 */
	/** ZIVIT Düsseldorf */
	...
	/** Neuer Wert  2013 */
	protected static final BigDecimal RENTBEMESSUNGSGR_OST_2013 = new BigDecimal(58800);

	/** Rentenbemessungs-Grenze alte Bundesländer in EUR */

	/** Neuer Wert 2013 */
	protected static final BigDecimal RENTBEMESSUNGSGR_WEST = new BigDecimal(69600);
	...
	@Override
	public BigDecimal getVkvlzz() { return VKVLZZ; }

	@Override
	public BigDecimal getWvfrbm() { /* required for newer calculator */ return null; }

	@Override
	public BigDecimal getVkvsonst() { return VKVSONST; }
	...
	/** Vorsorgepauschale (§ 39b Absatz 2 Satz 5 Nummer 3 und Absatz 4 EStG)<br>
  			Achtung: Es wird davon ausgegangen, dass	<br>
  				a) Es wird davon ausge-gangen, dassa) für die BBG (Ost) 58.800 Euro und für die BBG (West) 69.600 Euro festgelegt wird sowie<br>
	...
	protected void MVSP() {
/** Neuer Wert 2013 */
		if(ZRE4VP.compareTo( BigDecimal.valueOf(47250) ) == 1) {/** Neuer Wert 2013 */
